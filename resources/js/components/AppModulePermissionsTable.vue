    ...
    export default {
        ...
        methods: {
            ...
            onAction (action, data, index) {
                switch( action ){
                    case 'edit-item':
                        window.open("/app_module_permissions/form/"+data.id,'_blank');
                        break;
                    case 'delete-item':
            ...
            async deleteItem( dataId ){
                const response = await window.axios.delete('/api/app_module_permissions/'+dataId);
        ...
        data(){
            return {
                apiUrl: '/app_module_permissions/dataTables/'+this.$props.app_module_id,
                css: CssConfig,
                fields:[
                    'id',
                    {
